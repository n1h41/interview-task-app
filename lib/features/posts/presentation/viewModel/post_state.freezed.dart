...
class _$_PostState implements _PostState {
  ...
  @override
  String toString() {
    return 'PostState(status: $status, posts: $posts, currentPage: $currentPage, hasReachedMax: $hasReachedMax)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, status,
      const DeepCollectionEquality().hash(_posts), currentPage, hasReachedMax);
...
abstract class _PostState implements PostState {
  const factory _PostState(
      ...
      required final List<Post> posts,
      final int currentPage,
      final bool? hasReachedMax}) = _$_PostState;
